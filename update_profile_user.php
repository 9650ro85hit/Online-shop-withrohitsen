...
if(isset($_POST['submit'])){
    ...
    if($oldpass != $pass){
        ...
        if($rpass!=$rcpass){
            ...
            $query = "UPDATE `users` SET `name` = '$rname', `email` = '$remail', `password` = '$rpass' WHERE `users`.`id` = $user_id";
...
<html lang="en">
  ...
  <div class="mb-3 ">
    ...
    <label for="exampleInputEmail1" class="form-label" id="label" >User Email</label>
