...
if(isset($_POST['delete'])){
    ...
    $query = "DELETE FROM `wishlist` WHERE `wishlist`.`id` = $itemIDToDelete";
...
<section class="home-products">
  <h1 class="hedding">Your wishlist products</h1>
  ...
  <div class="products-sliderx">
    <div class="w">
      <?php
        ...
        $select_wishlist = $pdo->prepare("SELECT * FROM wishlist WHERE user_id = :user_id");
...
<a href="quick_view.php?id=<?= $fetch_wishlist['id']; ?>"><i class="bi bi-eye-fill"></i></a>
