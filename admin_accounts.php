...
if($_SERVER["REQUEST_METHOD"]){
    ...
    font-size: 20px; color:white;">New Admin</a>';
   echo ' </button>'; // Changed to type="submit"
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $id = $row['id'];
            ...
            echo ' <p style="margin-top: 10px; margin-bottom:10px margin-left:40px  maring-right:40px">Admin Username: ' . $name . '</p>';
           

            echo '<button class="btn btn-success" name="register">';
            echo '<a href="update_profile.php" style="text-decoration: none;
            font-size: 20px; color:white;">Update</a>';
           echo ' </button>';
